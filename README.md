...
It has some bugs that DB connection when replies are matching with posts. However, I have been known how to fix it since found this bug, but we won't fix it because this project was closed from us when 2015.01.
