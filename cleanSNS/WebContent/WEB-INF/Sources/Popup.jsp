...
<script type="text/javascript">
 	...
 	function popup()
 	{
		...
		document.getElementById("hiddenName").value=window.opener.document.all.name.value;
		document.getElementById("hiddenEmail").value=window.opener.document.all.password.value;
...
<body onload="popup()">
<div>
<form action="emailform.htm" id="checkForm" method="post">
