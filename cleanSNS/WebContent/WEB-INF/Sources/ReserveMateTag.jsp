...
function search()
{
	...
	{//실제 추가
		...
		window.opener.ModifyForm.mate1.value="";
		window.opener.ModifyForm.mate2.value="";
		window.opener.ModifyForm.mate3.value="";
		window.opener.ModifyForm.mate4.value="";
		window.opener.ModifyForm.mate5.value="";
		window.opener.ModifyForm.hidden1.value="";
		window.opener.ModifyForm.hidden2.value="";
		window.opener.ModifyForm.hidden3.value="";
		window.opener.ModifyForm.hidden4.value="";
		window.opener.ModifyForm.hidden5.value="";
			
		window.opener.ModifyForm.mate1.value=document.getElementById("mate1").value;
		window.opener.ModifyForm.mate2.value=document.getElementById("mate2").value;
		window.opener.ModifyForm.mate3.value=document.getElementById("mate3").value;
		window.opener.ModifyForm.mate4.value=document.getElementById("mate4").value;
		window.opener.ModifyForm.mate5.value=document.getElementById("mate5").value;
		window.opener.ModifyForm.hidden1.value=document.getElementById("hidden1").value;
		window.opener.ModifyForm.hidden2.value=document.getElementById("hidden2").value;
		window.opener.ModifyForm.hidden3.value=document.getElementById("hidden3").value;
		window.opener.ModifyForm.hidden4.value=document.getElementById("hidden4").value;
		window.opener.ModifyForm.hidden5.value=document.getElementById("hidden5").value;
