...
function search()
{
	...
	{//실제 추가
		...
		if(count!=0)		
		{list=document.getElementById("mate1").value+" "
		         +document.getElementById("mate2").value+" "
		         +document.getElementById("mate3").value+" "
		         +document.getElementById("mate4").value+" "
		         +document.getElementById("mate5").value;
		
			
		}
		
		
		window.opener.memberUpdateForm.mateList.value=list;
		window.opener.memberUpdateForm.hidden1.value=document.getElementById("hidden1").value;
		window.opener.memberUpdateForm.hidden2.value=document.getElementById("hidden2").value;
		window.opener.memberUpdateForm.hidden3.value=document.getElementById("hidden3").value;
		window.opener.memberUpdateForm.hidden4.value=document.getElementById("hidden4").value;
		window.opener.memberUpdateForm.hidden5.value=document.getElementById("hidden5").value;
...
<input type="hidden" id="mateCount" value="${count}">
